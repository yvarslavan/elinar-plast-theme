...
<section class="section-production-modern" id="about-production">
        ...
        <div class="production-visual-area">
            <div class="slider-container-modern">
                <div class="slider-track" id="productionSliderTrack">
                    ...
                    ?>
                        <?php
                            // Custom class for slide 11 to crop face
                            $extra_class = ($i === 11) ? 'slide-crop-face' : '';
                        ?>
                        <!-- Slide <?php echo $i; ?> -->
                        <div class="slider-slide <?php echo $is_active; ?> <?php echo $extra_class; ?>" aria-hidden="<?php echo $aria_hidden; ?>">
    ...
    <!-- Styles for specific modifications -->
    <style>
        /* Fix for Slide 11: Hide employee face, focus on hands and products */
        .slide-crop-face img {
        ...
        /* Fix for Slide 11 in GLightbox (Zoomed view) */
        /* Target image by src attribute to ensure it works globally in the lightbox overlay */
        .gslide-image img[src*="production-slide-11"],
        .glightbox-clean .gslide-media img[src*="production-slide-11"] {
            object-fit: cover !important;
            object-position: 80% 100% !important;
            transform: scale(1.75) !important;
            transform-origin: right bottom !important;
            min-height: 80vh !important; /* Ensure it takes up space to allow cropping */
        }
    </style>
</section>
