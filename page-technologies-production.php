                ...
                <article class="equipment-card">
                    ...
                    <div class="equipment-content">
                        ...
                        <ul class="equipment-list">
                            ...
                            <li>
                                <span class="check-icon">✓</span>
                                <span><strong>Стабильность процесса:</strong> Минимальные пульсации давления позволяют производить детали с тонкими стенками и высоким качеством поверхности.</span>
                            </li>
                            <li>
                                <span class="check-icon">✓</span>
                                <span><strong>Цифровой контроль:</strong> Оператор отслеживает параметры каждого цикла и сохраняет программы литья через интеллектуальную панель управления.</span>
                            </li>
                        </ul>
                    </div>
                </article>
                ...
                <article class="equipment-card">
                    ...
                    <div class="equipment-content">
                        ...
                        <ul class="equipment-list">
                            <li>
                                <span class="check-icon">✓</span>
                                <span><strong>Экструзия IDE:</strong> Одношнековые экструзионные линии с автоматической синхронизацией обеспечивают стабильную подачу расплава, гарантируя равномерную толщину стенок и гомогенность материала.</span>
                            </li>
                            <li>
                                <span class="check-icon">✓</span>
                            ...
                            <li>
                                <span class="check-icon">✓</span>
                                <span><strong>Ленточное тянущее устройство:</strong> В отличие от гусеничного, ленточное тянущее устройство исключает проскальзывание и деформацию профиля при протяжке.</span>
                            </li>
                            <li>
                                <span class="check-icon">✓</span>
                                <span><strong>Цифровой контроль и резка:</strong> Автоматическое поддержание температурных зон и высокоточное отрезное устройство для чистого реза с допуском +/- 0,3 мм, без заусенцев.</span>
                            </li>
                        </ul>
                    </div>
                </article>
            ...
            <div class="equipment-footer">
                <div class="equipment-footer-grid">
                    <div class="equipment-footer-col">
                        ...
                        <p class="equipment-footer-col-text">Собственная система водоподготовки и промышленные чиллеры для обеспечения стабильно высокого качества выпускаемой продукции.</p>
                    </div>
                    <div class="equipment-footer-col">
                        <h4 class="equipment-footer-col-title">Ремонт оснастки</h4>
                        <p class="equipment-footer-col-text">Свой слесарный участок для оперативного обслуживания и мелкого ремонта оснасток на месте.</p>
                    </div>
                    <div class="equipment-footer-col">
                        <h4 class="equipment-footer-col-title">Экономика и Zero Waste</h4>
                        <p class="equipment-footer-col-text">Используем собственные возвратные отходы, используем оборотную тару и минимально достаточную, но надежную упаковку.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="engineering-otk-grid">
                ...
                <div class="engineering-otk-content">
                    ...
                    <p class="engineering-otk-text">Технологическая база «Элинар Пласт» — это не только парк станков, но и строгий инженерный регламент. Мы исключаем работу «на глаз»: каждый этап, от сборки инструмента до выхода готового профиля, сопровождается инструментальными замерами. Это гарантирует идеальную повторяемость изделий в каждой партии.</p>
                    <ul class="engineering-otk-list">
                        <li>
                            <span class="check-icon">✓</span>
                            <span><strong>Верификация оснастки:</strong> На фото запечатлен аудит экструзионного инструмента (фильеры и калибратора). Перед каждым запуском инженеры проверяют сопряжение деталей и чистоту каналов, чтобы исключить дефекты поверхности и разностенность профиля.</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li>
                            <span class="check-icon">✓</span>
                            <span><strong>Технологическая экспертиза:</strong> Наши специалисты решают задачи любой сложности: от подбора оптимальных полимерных композиций до участия в разработке оснастки для профилей со сложной геометрией и внутренними перегородками.</span>
                        </li>
                    </ul>
                </div>
            </div>
